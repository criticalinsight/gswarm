...
### 5. Zero-Copy Threshold Needs Tuning Guidance — ✅ RESOLVED
...
**Resolution**: Added clear guidance to `performance_guide.md`:
...
### 6. `gclaw/` Has a Stale Forked Copy of GleamDB — ✅ RESOLVED
...
|---|---|---|
| EntityId unwrapping | Medium | ✅ `resolve_eid` added |
| TraversalStep import path | Low | ✅ Re-exported from `gleamdb` |
| Traverse vs Datalog | Info | ✅ Decision matrix documented |
| Prefetch default | Medium | ✅ Default changed to `True` |
| Zero-copy threshold guidance | Low | ✅ Added to `performance_guide.md` |
| gclaw fork drift | High | ✅ Vendor synced v2.4.0 |
| Sly ACP bridge | High | Pending — needs Rust ACP handler |
